...
import { CartItem, StoreMode, User } from '../types';
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex sm:pl-10 pl-0">
        <div className="w-full sm:w-96 max-w-full sm:max-w-md bg-slate-900/95 text-white shadow-2xl border-l border-white/15 backdrop-blur-2xl flex flex-col justify-between h-full">
          ...
          <div className="p-4 sm:p-6 border-b border-white/10 flex items-center justify-between shrink-0">
            ...
            <button
              onClick={onClose}
              className="p-2 text-slate-400 hover:text-white rounded-2xl hover:bg-white/10 border border-transparent hover:border-white/15 transition-all cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
            ...
            <div className="p-4 sm:p-6 border-t border-white/10 bg-slate-950/90 space-y-4 backdrop-blur-md shrink-0">
              ...
              <div className="grid grid-cols-1 gap-2.5">
                <button
                  ...
                  className="w-full py-4 rounded-2xl bg-[#20d8e2] hover:bg-[#1bc6cf] text-slate-950 font-black text-xs sm:text-sm flex items-center justify-center gap-2 backdrop-blur-xl shadow-xl shadow-[#20d8e2]/20 transition-all duration-300 cursor-pointer"
                >
                  <Truck className="w-5 h-5 text-slate-950" />
                  <span>Proceder a Registro de Despacho ➔</span>
                </button>
